...
class EnvironmentInterface(ABC):
    ...
    def get_all_states(self):
        raise NotImplementedError('get_all_states dose not implemented by environment: %s' % self.name)
    ...
    def get_all_actions(self):
        raise NotImplementedError('get_all_actions dose not implemented by environment: %s' % self.name)